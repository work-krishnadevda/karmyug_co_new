          ...
          <Dialog.Portal forceMount>
            ...
            <Dialog.Content asChild>
              <motion.div
                ...
                className="
                  fixed inset-0 z-50 flex h-full w-full flex-col overflow-hidden bg-white
              ...
              >
                ...
                {/* Body — exactly two possible scroll owners: the left info
                    panel (desktop only) and whatever is active on the right
                    (contact form or calendar). Nothing is nested inside an
                    already-scrolling ancestor, so there's never more than
                    one scrollbar fighting for the same gesture. */}
                <div className="grid min-h-0 flex-1 grid-cols-1 overflow-hidden md:grid-cols-[320px_1fr]">
                  ...
                  <div className="flex min-h-0 flex-col overflow-hidden bg-[#0F2545]">
                    {step === "calendar" && (
                      <button
                        onClick={onBack}
                    ...
                    <div className="min-h-0 flex-1">
                      {step === "details" ? (
                        <div className="scrollbar-thin-dark h-full overflow-y-auto overscroll-contain bg-[#0F2545]">
                          <ContactForm
                            meeting={meeting}
