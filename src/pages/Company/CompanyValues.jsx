        ...
        <div className="mt-20 grid gap-8 md:grid-cols-2 xl:grid-cols-3">
          ...
          {values.map((value) => {
            ...
            return (
              ...
              >
                {/* Gradient Glow */}
                <div className="absolute inset-0 bg-gradient-to-br from-blue-500/0 to-violet-500/0 opacity-0 transition duration-500 group-hover:opacity-100 group-hover:from-blue-50 group-hover:to-violet-50" />
