...
const WhyChooseUs = () => {
  return (
    <section className="relative bg-white py-28 overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 h-80 w-80 rounded-full bg-brand-light-blue/15 blur-[150px]" />
        ...
        <div className="mt-20 grid gap-8 md:grid-cols-2 xl:grid-cols-3">
          ...
          {features.map((feature) => {
            ...
            return (
              ...
              >
                {/* Hover Gradient */}
                <div className="absolute inset-0 bg-gradient-to-br from-blue-500/0 via-blue-500/0 to-brand-light-blue/0 group-hover:from-brand-primary/5 group-hover:to-brand-light-blue/10 transition-all duration-500" />
