    ...
    <section className="relative overflow-hidden bg-white py-28">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="mt-20 grid gap-10 lg:grid-cols-2">
          ...
          <div className="group relative overflow-hidden rounded-3xl border border-gray-200 bg-white p-10 shadow-lg transition duration-500 hover:-translate-y-3 hover:border-violet-500 hover:shadow-2xl">

            <div className="absolute -left-10 -bottom-10 h-40 w-40 rounded-full bg-violet-500/10 blur-3xl transition group-hover:scale-125"></div>
