...
import officeImage from "../../assets/images/company/office.webp";
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="relative order-2 lg:order-1">
            <div className="absolute inset-0 rounded-[40px] bg-gradient-to-br from-blue-500/10 via-brand-light-blue/10 to-cyan-500/10 blur-3xl"></div>
          ...
          <div className="order-1 lg:order-2">
            ...
            <h2 className="mt-6 text-4xl lg:text-5xl font-bold text-gray-900">
              ...
              <span className="block text-blue-600">Growing Businesses</span>
            </h2>

            <p className="mt-8 text-lg leading-8 text-gray-600">
              Karmyug is a software development company helping startups, SMEs,
              and enterprises simplify operations through intelligent digital
              solutions.
            </p>

            <p className="mt-6 text-lg leading-8 text-gray-600">
              From websites and mobile applications to CRM, HRMS, ERP, workflow
              automation and AI integration, we build scalable systems that
              improve productivity and create measurable business impact.
            </p>
