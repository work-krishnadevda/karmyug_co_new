...
import aiImage from "../../assets/images/company/ai.png";
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="grid items-center gap-20 lg:grid-cols-2">
          ...
          <div className="relative">
            ...
            <div className="absolute inset-0 rounded-[40px] bg-gradient-to-br from-blue-500/10 via-cyan-400/10 to-violet-500/10 blur-3xl"></div>
