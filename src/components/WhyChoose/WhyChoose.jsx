...
export default function WhyChoose() {
  const { active, next, previous, goTo, setPaused } = useCarousel(
      ...
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 items-center gap-20 px-6 lg:grid-cols-2">
        ...
        <div>
          ...
          <div className="mt-12 flex flex-wrap gap-4">
            <motion.button
              ...
              className="flex cursor-pointer items-center gap-2 rounded-xl px-7 py-4 font-semibold text-white shadow-lg"
        ...
        <div className="relative">
          ...
          <div className="mt-8 flex items-center justify-center gap-4">
            <button
              onClick={previous}
              className="rounded-full cursor-pointer border bg-white p-3 shadow hover:bg-slate-50"
            >
              <ChevronLeft />
            </button>
