    ...
    <section className="relative overflow-x-hidden min-h-screen pt-20 md:pt-28 flex items-center justify-center bg-white">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 text-center">
        ...
        <div className="mt-8 flex flex-col sm:flex-row justify-center gap-4 px-4">
          <button className="w-full sm:w-auto bg-[#2563EB] hover:bg-[#1D4ED8] text-white font-semibold px-8 py-4 rounded-xl transition-all duration-300 shadow-[0_10px_25px_rgba(37,99,235,0.25)]">
            Start for FREE
          </button>
          <button className="w-full sm:w-auto bg-white border border-slate-300 hover:border-[#2563EB] hover:text-[#2563EB] text-slate-700 font-semibold px-8 py-4 rounded-xl transition-all duration-300">
            Schedule a Demo
          </button>
        </div>
